...
mostrar_linhas_com_colunasvazias = fifa[fifa.isnull().any(axis=1)][null_columns]
mostrar_linhas_com_colunasvazias
...
variancia = round(pca.explained_variance_ratio_[0], 3)
variancia
...
PCA = np.round(pca.components_.dot(x)[:2], 3)
...
def q4():
    ...
    # Separando variaveis de interesse como Overall
    X = fifa.drop('Overall', 1)
    y = fifa['Overall']
    
    # Criando objeto rfe e aplicando metodo
    lr = LinearRegression()
